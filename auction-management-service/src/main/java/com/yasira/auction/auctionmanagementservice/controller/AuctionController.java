...
public class AuctionController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<AuctionResponseDTO>> createAuction(@Valid @RequestBody AuctionRequestDTO auctionRequestDTO) {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<AuctionResponseDTO>>> getAllAuctions() {
        List<AuctionResponseDTO> auctionsList = auctionService.getAllAuctions();
        return ResponseEntity
                .ok(new ApiResponse<>(
                        true,
                        "Auctions List retrieved successfully",
                        auctionsList
                ));
    }
